...
iex (irm https://raw.githubusercontent.com/raffie-usb/CPU/refs/heads/main/CPU-ap-menu.ps1)

Write-Host -Foreground Red $GroupTag
sleep -Seconds 3

iex (irm https://raw.githubusercontent.com/raffie-usb/CPU/refs/heads/main/CPU-functions.ps1)
